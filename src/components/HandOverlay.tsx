...
const HandOverlay = ({
  ...
  return (
    <>
      ...
      {showOverlay && (
        <div className="absolute bottom-4 right-4 w-[160px] max-w-[40vw] h-[120px] rounded-xl border border-white/20 bg-black/35 backdrop-blur-md overflow-hidden shadow-lg">
          {!hasPermission ? (
            <button
